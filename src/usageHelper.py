...
def plot_lines(lines, figsize=(18, 18), margin=10, plot_points = True, alpha=.15):
    ...
    for line in lines:
        ...
        plt_line = matplotlib.lines.Line2D(xdata, ydata, linewidth=1, axes=ax, color='#ff2222', alpha=alpha)
